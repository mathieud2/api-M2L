...
class RedBean_ModelHelper implements RedBean_Observer
{
	...
	/**
	 * Given a models ID (models identifier) this method returns the
	 * full models name.
	 *
	 * @param string           $model
	...
	/**
	 * Sets the models formatter to be used to discover a models
	 * for Fuse.
	 *
	 ...
	 *
	 * @param string $modelClassName name of the models
	 *
	 * @return object
	 */
	 ...
	 * CRUD events. If a CRUD event occurs it will send a signal to the models
	 * that belongs to the CRUD bean and this models will take over control from
	 * there.
	 *
