...
class RedBean_OODB extends RedBean_Observable
{
	...
	/**
	 * Unboxes a bean from a FUSE models if needed and checks whether the bean is
	 ...
	 *
	 * @param RedBean_OODBBean|RedBean_SimpleModel $embeddedBean the bean or models
	 *
	 * @return integer
	 */
	...
	public function store( $bean )
	{
		...
		$processLists = $this->hasListsOrObjects( $bean ); //check again, might have changed by models!
		if ( $processLists ) {
