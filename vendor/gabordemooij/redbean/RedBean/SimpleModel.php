...
class RedBean_SimpleModel
{
	...
	/**
	 * Used by FUSE: the ModelHelper class to connect a bean to a models.
	 * This method loads a bean in the models.
	 *
	...
	/**
	 * Box the bean using the current models.
	 * This method wraps the current bean in this models.
	...
	/**
	 * Unbox the bean from the models.
	 * This method returns the bean inside the models.
	 *
